...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productList.add(new Product(1, "Test 1", 10.0));
        productList.add(new Product(2, "Test 2", 20.0));
        productList.add(new Product(3, "Test 3", 30.0));
        productList.add(new Product(4, "Test 4", 40.0));
        productList.add(new Product(5, "Test 5", 50.0));
        ...
        buttonShowCheckedItems.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(MainActivity.this, "Выберите товары!", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void updateCheckedCountAndSum() {
        ...
        textViewCheckedCount.setText("Выделено: " + count);
        textViewTotalSum.setText("Итог: " + totalSum + " BYN");
    }
}
